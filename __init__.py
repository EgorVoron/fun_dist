...
def func2circle(*, func, circle_center_x, circle_center_y, circle_radius, init_args=(0, 0), maxiter=500):
...
def point2func(*, func, point_x, point_y, init_args=(0, 0), maxiter=500):
